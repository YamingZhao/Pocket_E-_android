 ...
 */
public class WorkerServiceOrderListFragment  extends BaseListFragment<OrderListItemModel, WorkerOrderListItemViewHolder> {

    private String serviceOrderStatus;

    public WorkerServiceOrderListFragment() {
        serviceOrderStatus = "";
    }
    ...
    protected int getListItemLayoutResourceId() {
        return R.layout.listitem_order_worker;
    }
